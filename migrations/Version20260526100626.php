 ...
 */
final class Version20260526100626 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX uniq_8d93d6492cd287c1');
        $this->addSql('ALTER TABLE "user" DROP recident_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ADD recident_id INT NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX uniq_8d93d6492cd287c1 ON "user" (recident_id)');
    }
}
